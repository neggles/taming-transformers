...
class ObjectsCenterPointsConditionalBuilder:
    ...
    def plot(
        ...
        font = ImageFont.truetype(
            "/usr/share/fonts/truetype/lato/Lato-Regular.ttf", size=get_plot_font_size(font_size, figure_size)
        )
    ...
    def build(
        self, annotations: List, crop_coordinates: Optional[BoundingBox] = None, horizontal_flip: bool = False
    ) -> LongTensor:
